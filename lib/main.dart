...
import 'package:akhmedov_school/screens/home/home_screen.dart';
import 'package:akhmedov_school/screens/splash/splash_screen.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget getScreen() {
    final loginStatus = box.read('isLogged');
  ...
  Widget build(BuildContext context) {
    ...
    //: (box.read('isLogged') == '0094' || box.read('isLogged') == 'admin' ? AdminHomeScreen():HomeScreen()),